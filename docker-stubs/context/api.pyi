...
class ContextAPI:
    ...
    @classmethod
    def create_context(cls, name, orchestrator: Incomplete | None = ..., host: Incomplete | None = ..., tls_cfg: Incomplete | None = ..., default_namespace: Incomplete | None = ..., skip_tls_verify: bool = ...): ...
    @classmethod
